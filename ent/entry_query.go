...
func (eq *EntryQuery) QueryAccount() *AccountQuery {
...
func (eq *EntryQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (eq *EntryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (eq *EntryQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (eq *EntryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (eq *EntryQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
func (eq *EntryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (eq *EntryQuery) WithAccount(opts ...func(*AccountQuery)) *EntryQuery {
	query := &AccountQuery{config: eq.config}
