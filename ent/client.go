...
// QueryOutbounds queries the outbounds edge of a Account.
func (c *AccountClient) QueryOutbounds(a *Account) *TransferQuery {
...
// QueryInbounds queries the inbounds edge of a Account.
func (c *AccountClient) QueryInbounds(a *Account) *TransferQuery {
	query := &TransferQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := a.ID
		step := sqlgraph.NewStep(
